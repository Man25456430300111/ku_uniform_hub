...
//           } else {
//             alert('ยอดเงินในบัตรไม่เพียงพอ');
//           }
//         } else {
//           alert('ข้อมูลบัตรไม่ถูกต้อง');
//         }
//       } catch (error) {
...
//             // แจ้งเตือนการชำระเงินสำเร็จด้วย SweetAlert2
//             Swal.fire({
//               icon: 'success',
//               title: 'Payment Successful',
//               text: 'Your payment was completed successfully!'
//             }).then(() => {
//               // ลบสินค้าทั้งหมดใน cart หลังจากชำระเงินเสร็จสิ้น
//               const cartRef = collection(db, "users", user.uid, "cart");
//               getDocs(cartRef).then((cartSnapshot) => {
//                 cartSnapshot.forEach((doc) => {
//                   deleteDoc(doc.ref);
//                 });
//                 // เปลี่ยนหน้าไปที่ /category หลังจากชำระเงินสำเร็จ
//                 navigate('/category');
//               });
//             });
//           } else {
